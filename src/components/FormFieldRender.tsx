...
const FormFieldRender: React.FC<FormFieldRenderProps> = ({
    ...
    // if (
    //     field.dependencies &&
    //     !field.dependencies.every((dep) => watchedValues[dep.field] === dep.value)
    // ) {
    //     return null;
    // }
    // console.log(
    ...
    if (
        ...
        !field.dependencies.every((dep) => {
            ...
            // Check if dep.value is a Zod type and validate the watchedValue
            if (depValue instanceof z.ZodType) {
                return depValue.safeParse(watchedValue).success;
            }

            // Otherwise, perform direct comparison
